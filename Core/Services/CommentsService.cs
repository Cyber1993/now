...
namespace Core.Services
{
                                 ...
                                 IMapper mapper, IImagesService imagesService) : ICommentsService
    {
        ...
        public async Task Edit(int commentId, EditCommentDto editCommentDto)
        {
            ...
            if (editCommentDto.Images != null && editCommentDto.Images.Any())
            {
                foreach (var imageFile in editCommentDto.Images)
                {
            ...
            mapper.Map(editCommentDto, existingComment);
